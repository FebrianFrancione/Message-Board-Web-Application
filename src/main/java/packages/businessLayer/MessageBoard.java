...
//    }
    ...
    public String displaySearchByDates(String fromDate, String toDate, int i, String reverse) throws IOException{
        String out = "";
        ArrayList<Post> searchedByDates = daoObj.searchByDates(fromDate,toDate);
